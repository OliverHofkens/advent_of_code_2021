...
def parse_board_state(lines: List[str]) -> State:
    ...
    hall = []
    rooms = []
    for idx, (hall_tile, occ_1, occ_2) in enumerate(zip(*lines)):
        if hall_tile == "#":
            continue
        if occ_1 == "#":
